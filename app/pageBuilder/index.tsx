"use client";
import { Button, Data, Puck, Render, usePuck, IconButton } from "@measured/puck";
...
const PageBuilder = ({ path, data, onSave }: { path: string, data: Data, onSave: (data: Data) => Promise<any> }) => {
        ...
        <Puck
            ...
            overrides={{
                ...
                headerActions: function HeaderActiond({ children }) {
                    ...
                    const hasChanges = initData.current !== JSON.stringify(p.appState.data)
